...
move_uploaded_file($_FILES["serviceimage"]["tmp_name"],"policestationimg/".$_FILES["serviceimage"]["name"]);
$sql="INSERT INTO tblpolicestation(Location,MobileNumber,Description,P_img) VALUES(:title,:mobile,:description,:pimage)";
...
if($lastInsertId)
{
$msg=" Add Police Station Successfully";
}
else 
{
...
<!--heder end here-->
	<ol class="breadcrumb">
                <li class="breadcrumb-item"><a href="index.html">Home</a><i class="fa fa-angle-right"></i>Update Police Station Info </li>
            </ol>
		<!--grid-->
 	<div class="grid-form">
