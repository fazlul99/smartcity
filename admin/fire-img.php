...
$sql="update tblfiresearvice set Fire_img=:pimage where id=:imgid";
...
<html>
<head>
<title>Smart City | Admin Update Image</title>
...
<!--heder end here-->
	<ol class="breadcrumb">
                <li class="breadcrumb-item"><a href="index.html">Home</a><i class="fa fa-angle-right"></i>Update Fire Service Image </li>
            </ol>
		<!--grid-->
 	<div class="grid-form">
...
<!---->
  <div class="grid-form1">
  	       <h3>Update Fire Service Image </h3>
  	         ...
  	         <div class="tab-content">
						...
						<?php 
$imgid=intval($_GET['imgid']);
$sql = "SELECT Fire_img from  tblfiresearvice where id=:imgid";
$query = $dbh -> prepare($sql);
$query -> bindParam(':imgid', $imgid, PDO::PARAM_STR);
$query->execute();
...
<div class="col-sm-8">
<img src="serviceimages/<?php echo htmlentities($result->Fire_img);?>" width="200">
</div>
</div>
