...
$sql="INSERT INTO Tblhotel(HotelName,HotelType,HotelLocation,Price,HotelDetails,HotelImage) VALUES(:pname,:ptype,:plocation,:pprice,:pdetails,:pimage)";
...
<html>
<head>
<title>Smart City || Admin Hotel Inserting </title>
						...
						<div class="tab-pane active" id="horizontal-form">
							<form class="form-horizontal" name="hotel" method="post" enctype="multipart/form-data">
								<div class="form-group">
									...
									<div class="col-sm-8">
										<input type="text" class="form-control1" name="hotelname" id="hotelname" placeholder="Add Hotel" required></input>
									</div>
								</div>
<div class="form-group">
									<label for="focusedinput" class="col-sm-2 control-label">Hotel Type</label>
									<div class="col-sm-8">
										<input type="text" class="form-control1" name="hoteltype" id="hoteltype" placeholder=" Hotel Type " required></input>
									</div>
								</div>
...
<div class="form-group">
									...
									<div class="col-sm-8">
										<input type="text" class="form-control1" name="hotellocation" id="hotellocation" placeholder=" Hotel Location" required></input>
									</div>
								</div>
...
<div class="form-group">
									...
									<div class="col-sm-8">
										<input type="text" class="form-control1" name="price" id="price" placeholder=" Hotel Fare" required></input>
									</div>
								</div>
...
<div class="form-group">
									...
									<div class="col-sm-8">
										<input type="file" name="hotelimage" id="hotelimage" required></input>
									</div>
								</div>	
