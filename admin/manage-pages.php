...
<html>
<head>
<title>Smart City || Admin Manage Pages</title>
...
<div class="form-group">
									...
									<div class="col-sm-8">
										...
										<textarea class="form-control" rows="5" cols="50" name="pgedetails" id="pgedetails" placeholder="Service Details" required>
										<?php 
$pagetype=$_GET['type'];
