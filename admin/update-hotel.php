...
$sql="update Tblhotel set HotelName=:pname,HotelType=:ptype,HotelLocation=:plocation,Price=:pprice,HotelDetails=:pdetails where HotelId=:pid";
...
<html>
<head>
<title>Smart City || Admin Update Hotel </title>
...
{	?>
							...
							<form class="form-horizontal" name="hotel" method="post" enctype="multipart/form-data">
								<div class="form-group">
									...
									<div class="col-sm-8">
										<input type="text" class="form-control1" name="hotelname" id="hotelname" placeholder="Add Hotel" value="<?php echo htmlentities($result->HotelName);?>" required>
									</div>
								</div>
<div class="form-group">
									<label for="focusedinput" class="col-sm-2 control-label">Hotel Type</label>
									<div class="col-sm-8">
										<input type="text" class="form-control1" name="hoteltype" id="hoteltype" placeholder=" Hotel Type " value="<?php echo htmlentities($result->HotelType);?>" required>
									</div>
								</div>
...
<div class="form-group">
									<label for="focusedinput" class="col-sm-2 control-label">Hotel Fare</label>
									<div class="col-sm-8">
										<input type="text" class="form-control1" name="price" id="price" placeholder=" Hotel Fare" value="<?php echo htmlentities($result->Price);?>" required>
									</div>
								</div>
...
<div class="col-sm-8">
<img src="hotelimages/<?php echo htmlentities($result->HotelImage);?>" width="200">&nbsp;&nbsp;&nbsp;<a href="hotel-image.php?imgid=<?php echo htmlentities($result->HotelId);?>">Change Image</a>
</div>
</div>
